...
(function() {
  var UPDATE_INTERVAL, bsort, canvas, colours, context, defer, height, hsort, initColours, isort, qsort, rectHeight, rectWidth, reset, sort, sort_context, ssort, swapRects, timeouts, toHslString, width;
